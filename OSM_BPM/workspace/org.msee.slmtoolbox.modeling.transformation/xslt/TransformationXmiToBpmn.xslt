...
<xsl:stylesheet version="2.0"
	...
	xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:bpmn2xmi="http://www.omg.org/spec/BPMN/20100524/MODEL-XMI"
	...
	<xsl:template name="SplitStringCore">
		...
		<xsl:if test="string-length($list) > 2">
	...
	<xsl:template name="ActivityTemplate">
		...
		<xsl:for-each select="resources">
			<xsl:choose>
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'Performer' or substring-after(@xsi:type, ':') = 'Performer'">
					<bpmn2:performer>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'HumanPerformer' or substring-after(@xsi:type, ':') = 'HumanPerformer'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'PotentialOwner' or substring-after(@xsi:type, ':') = 'PotentialOwner'">
		...
		<xsl:for-each select="loopCharacteristics">
			<xsl:choose>
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'MultiInstanceLoopCharacteristics' or substring-after(@xsi:type, ':') = 'MultiInstanceLoopCharacteristics'">
					<bpmn2:multiInstanceLoopCharacteristics>
						<xsl:call-template
							name="MultiInstanceLoopCharacteristicsAttributesTemplate" />
						<xsl:call-template name="MultiInstanceLoopCharacteristicsTemplate" />
					</bpmn2:multiInstanceLoopCharacteristics>
				</xsl:when>
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'StandardLoopCharacteristics' or substring-after(@xsi:type, ':') = 'StandardLoopCharacteristics'">
	...
	<xsl:template name="CallActivityAttributesTemplate">
		...
		<xsl:if test="@calledElementRef">
			<xsl:attribute name="calledElement"> <xsl:value-of select="@calledElementRef" /> </xsl:attribute>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template name="CatchEventTemplate">
		...
		<xsl:for-each select="eventDefinitions">
			<xsl:choose>
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'CancelEventDefinition' or substring-after(@xsi:type, ':') = 'CancelEventDefinition'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'CompensateEventDefinition' or substring-after(@xsi:type, ':') = 'CompensateEventDefinition'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'ConditionalEventDefinition' or substring-after(@xsi:type, ':') = 'ConditionalEventDefinition'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'ErrorEventDefinition' or substring-after(@xsi:type, ':') = 'ErrorEventDefinition'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'EscalationEventDefinition' or substring-after(@xsi:type, ':') = 'EscalationEventDefinition'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'LinkEventDefinition' or substring-after(@xsi:type, ':') = 'LinkEventDefinition'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'MessageEventDefinition' or substring-after(@xsi:type, ':') = 'MessageEventDefinition'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'SignalEventDefinition' or substring-after(@xsi:type, ':') = 'SignalEventDefinition'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'TerminateEventDefinition' or substring-after(@xsi:type, ':') = 'TerminateEventDefinition'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'TimerEventDefinition' or substring-after(@xsi:type, ':') = 'TimerEventDefinition'">
	...
	<xsl:template name="CollaborationTemplate">
		...
		<xsl:for-each select="artifacts">
			<xsl:choose>
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'Association' or substring-after(@xsi:type, ':') = 'Association'">
					<bpmn2:association>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'Group' or substring-after(@xsi:type, ':') = 'Group'">
					<bpmn2:group>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'TextAnnotation' or substring-after(@xsi:type, ':') = 'TextAnnotation'">
		...
		<xsl:for-each select="conversations">
			<xsl:choose>
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'CallConversation' or substring-after(@xsi:type, ':') = 'CallConversation'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'Conversation' or substring-after(@xsi:type, ':') = 'Conversation'">
					<bpmn2:conversation>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'SubConversation' or substring-after(@xsi:type, ':') = 'SubConversation'">
	...
	<xsl:template name="CorrelationPropertyTemplate">
		...
		<xsl:for-each select="correlationPropertyRetrievalExpression">
			<bpmn2:correlationPropertyRetrievalExpression>
				<xsl:call-template
					name="CorrelationPropertyRetrievalExpressionAttributesTemplate" />
	...
	<xsl:template name="DataInputTemplate">
		...
		<xsl:call-template name="SplitString">
			...
			<xsl:with-param name="elementName"
				select="'bpmn2:inputSetWithWhileExecuting'" />
			<xsl:with-param name="elementNamespace"
				select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
		</xsl:call-template>
		<xsl:call-template name="SplitString">
	...
	<xsl:template name="DataOutputTemplate">
		...
		<xsl:call-template name="SplitString">
			...
			<xsl:with-param name="elementName"
				select="'bpmn2:outputSetWithWhileExecuting'" />
			<xsl:with-param name="elementNamespace"
				select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
		</xsl:call-template>
		<xsl:call-template name="SplitString">
	...
	<xsl:template name="DefinitionsTemplate" match="//bpmn2xmi:Definitions">
		<bpmn2:definitions
			...
			<xsl:for-each select="rootElements">
				<xsl:choose>
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'EventDefinition' or substring-after(@xsi:type, ':') = 'EventDefinition'">
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'Category' or substring-after(@xsi:type, ':') = 'Category'">
						<bpmn2:category>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'CorrelationProperty' or substring-after(@xsi:type, ':') = 'CorrelationProperty'">
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'DataStore' or substring-after(@xsi:type, ':') = 'DataStore'">
						<bpmn2:dataStore>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'EndPoint' or substring-after(@xsi:type, ':') = 'EndPoint'">
						<bpmn2:endPoint>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'Error' or substring-after(@xsi:type, ':') = 'Error'">
						<bpmn2:error>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'Escalation' or substring-after(@xsi:type, ':') = 'Escalation'">
						<bpmn2:escalation>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'GlobalBusinessRuleTask' or substring-after(@xsi:type, ':') = 'GlobalBusinessRuleTask'">
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'GlobalManualTask' or substring-after(@xsi:type, ':') = 'GlobalManualTask'">
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'GlobalScriptTask' or substring-after(@xsi:type, ':') = 'GlobalScriptTask'">
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'GlobalTask' or substring-after(@xsi:type, ':') = 'GlobalTask'">
						<bpmn2:globalTask>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'GlobalUserTask' or substring-after(@xsi:type, ':') = 'GlobalUserTask'">
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'Interface' or substring-after(@xsi:type, ':') = 'Interface'">
						<bpmn2:interface>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'ItemDefinition' or substring-after(@xsi:type, ':') = 'ItemDefinition'">
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'Message' or substring-after(@xsi:type, ':') = 'Message'">
						<bpmn2:message>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'PartnerEntity' or substring-after(@xsi:type, ':') = 'PartnerEntity'">
						<bpmn2:partnerEntity>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'PartnerRole' or substring-after(@xsi:type, ':') = 'PartnerRole'">
						<bpmn2:partnerRole>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'Process' or substring-after(@xsi:type, ':') = 'Process'">
						<bpmn2:process>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'Resource' or substring-after(@xsi:type, ':') = 'Resource'">
						<bpmn2:resource>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'Signal' or substring-after(@xsi:type, ':') = 'Signal'">
						<bpmn2:signal>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'Choreography' or substring-after(@xsi:type, ':') = 'Choreography'">
						<bpmn2:choreography>
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'GlobalConversation' or substring-after(@xsi:type, ':') = 'GlobalConversation'">
					...
					<xsl:when
						test="substring-after(@xmi:type, ':') = 'GlobalChoreographyTask' or substring-after(@xsi:type, ':') = 'GlobalChoreographyTask'">
			...
			<!-- variable containing the number of lanes to be created -->
			<xsl:variable name="numberLanes">
				<xsl:for-each select="rootElements">
					<xsl:if test="substring-before(@id, '_') = 'EaProcessImpl'">
			...
			<!-- Start creating the graphical objects. The root element of all graphical elements is the bpmndi:BPMNDiagram  -->
			<bpmndi:BPMNDiagram>
				<xsl:attribute name="id">
					<xsl:text>BPMNDiagram</xsl:text>
				</xsl:attribute>
				<bpmndi:BPMNPlane>
					<xsl:attribute name="id">
						<xsl:text>BPMNPlane</xsl:text>
					</xsl:attribute>
					<xsl:attribute name="bpmnElement">
						<xsl:value-of select="$planeID" />
					</xsl:attribute>
					<!-- create pools  -->
					<xsl:for-each select="rootElements">
						<xsl:if
							...
							<xsl:for-each select="participants">
								...
								<!-- after creating the pools we call two templates to create the message flows depending if the pool
								is a source or target of the message flow-->
								<xsl:call-template name="CreateOutputMessageFlow">
									<xsl:with-param name="idOfSource" select="$idForMessage"></xsl:with-param>
									<xsl:with-param name="x" select="170"></xsl:with-param>
									<xsl:with-param name="y"
										select="((number(position()) -1 )* 200)+ (number(position()) * 100.0) + ($numberLanes * 200) + 100"></xsl:with-param>
								</xsl:call-template>

								<xsl:call-template name="CreateInputMessageFlow">
									<xsl:with-param name="idOfTarget" select="$idForMessage"></xsl:with-param>
									<xsl:with-param name="x" select="170"></xsl:with-param>
									<xsl:with-param name="y"
										select="((number(position()) -1 )* 200)+ (number(position()) * 100.0) + ($numberLanes * 200) + 100"></xsl:with-param>
								</xsl:call-template>
					...
					<!-- create all flowelements of the process -->
					<xsl:for-each select="rootElements">
						<xsl:if
							test="substring-after(@xmi:type, ':') = 'Process' or substring-after(@xsi:type, ':') = 'Process'">

							<xsl:call-template name="BPMNDiagramTemplate"></xsl:call-template>
						</xsl:if>
	...
	<xsl:template name="ExtensionAttributeValueTemplate">
		...
		<xsl:call-template name="SplitString">
			...
			<xsl:with-param name="elementName"
				select="'bpmn2:extensionAttributeDefinition'" />
			<xsl:with-param name="elementNamespace"
				select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template name="FlowElementsContainerTemplate">
		...
		<xsl:for-each select="flowElements">
			<xsl:choose>
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'AdHocSubProcess' or substring-after(@xsi:type, ':') = 'AdHocSubProcess'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'BoundaryEvent' or substring-after(@xsi:type, ':') = 'BoundaryEvent'">
					<bpmn2:boundaryEvent>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'BusinessRuleTask' or substring-after(@xsi:type, ':') = 'BusinessRuleTask'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'CallActivity' or substring-after(@xsi:type, ':') = 'CallActivity'">
					<bpmn2:callActivity>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'CallChoreography' or substring-after(@xsi:type, ':') = 'CallChoreography'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'ChoreographyTask' or substring-after(@xsi:type, ':') = 'ChoreographyTask'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'ComplexGateway' or substring-after(@xsi:type, ':') = 'ComplexGateway'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'DataObject' or substring-after(@xsi:type, ':') = 'DataObject'">
					<bpmn2:dataObject>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'DataObjectReference' or substring-after(@xsi:type, ':') = 'DataObjectReference'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'DataStoreReference' or substring-after(@xsi:type, ':') = 'DataStoreReference'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'EndEvent' or substring-after(@xsi:type, ':') = 'EndEvent'">
					<bpmn2:endEvent>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'Event' or substring-after(@xsi:type, ':') = 'Event'">
					<bpmn2:event>
						<xsl:call-template name="EventAttributesTemplate" />
						<xsl:call-template name="EventTemplate" />
					</bpmn2:event>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'EventBasedGateway' or substring-after(@xsi:type, ':') = 'EventBasedGateway'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'ExclusiveGateway' or substring-after(@xsi:type, ':') = 'ExclusiveGateway'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'ImplicitThrowEvent' or substring-after(@xsi:type, ':') = 'ImplicitThrowEvent'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'InclusiveGateway' or substring-after(@xsi:type, ':') = 'InclusiveGateway'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'IntermediateCatchEvent' or substring-after(@xsi:type, ':') = 'IntermediateCatchEvent'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'IntermediateThrowEvent' or substring-after(@xsi:type, ':') = 'IntermediateThrowEvent'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'ManualTask' or substring-after(@xsi:type, ':') = 'ManualTask'">
					<bpmn2:manualTask>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'ParallelGateway' or substring-after(@xsi:type, ':') = 'ParallelGateway'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'ReceiveTask' or substring-after(@xsi:type, ':') = 'ReceiveTask'">
					<bpmn2:receiveTask>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'ScriptTask' or substring-after(@xsi:type, ':') = 'ScriptTask'">
					<bpmn2:scriptTask>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'SendTask' or substring-after(@xsi:type, ':') = 'SendTask'">
					<bpmn2:sendTask>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'ServiceTask' or substring-after(@xsi:type, ':') = 'ServiceTask'">
					<bpmn2:serviceTask>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'StartEvent' or substring-after(@xsi:type, ':') = 'StartEvent'">
					<bpmn2:startEvent>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'SubChoreography' or substring-after(@xsi:type, ':') = 'SubChoreography'">
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'SubProcess' or substring-after(@xsi:type, ':') = 'SubProcess'">
					<bpmn2:subProcess>
						<xsl:call-template name="SubProcessAttributesTemplate" />
						<xsl:call-template name="SubProcessTemplate" />
					</bpmn2:subProcess>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'Task' or substring-after(@xsi:type, ':') = 'Task'">
					<bpmn2:task>
						<xsl:call-template name="TaskAttributesTemplate" />
						<xsl:call-template name="TaskTemplate" />
					</bpmn2:task>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'Transaction' or substring-after(@xsi:type, ':') = 'Transaction'">
					<bpmn2:transaction>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'UserTask' or substring-after(@xsi:type, ':') = 'UserTask'">
					<bpmn2:userTask>
						<!-- <xsl:call-template name="UserTaskAttributesTemplate" /> <xsl:call-template 
		...
		<xsl:for-each select="flowElements">
			<xsl:if
				test="substring-after(@xmi:type, ':') = 'SequenceFlow' or substring-after(@xsi:type, ':') = 'SequenceFlow'">
	...
	<xsl:template name="InteractionNodeTemplate">
		<xsl:call-template name="SplitString">
			...
			<xsl:with-param name="elementName"
				select="'bpmn2:incomingConversationLinks'" />
			<xsl:with-param name="elementNamespace"
				select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
		</xsl:call-template>
		<xsl:call-template name="SplitString">
			...
			<xsl:with-param name="elementName"
				select="'bpmn2:outgoingConversationLinks'" />
			<xsl:with-param name="elementNamespace"
				select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
		</xsl:call-template>
	</xsl:template>
	...
	<xsl:template name="OutputSetTemplate">
		...
		<xsl:call-template name="SplitString">
			...
			<xsl:with-param name="elementName"
				select="'bpmn2:whileExecutingOutputRefs'" />
			<xsl:with-param name="elementNamespace"
				select="'http://www.omg.org/spec/BPMN/20100524/MODEL'" />
		</xsl:call-template>
		<xsl:call-template name="SplitString">
	...
	<xsl:template name="ResourceAssignmentExpressionTemplate">
		<xsl:for-each select="expression">
			<xsl:choose>
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'FormalExpression' or substring-after(@xsi:type, ':') = 'FormalExpression'">
	...
	<xsl:template name="BPMNDiagramTemplate">
		<xsl:variable name="coordinates">
			<entry key="id1">1</entry>
			<entry key="id2">2</entry>
		</xsl:variable>
		<!-- create lanes -->
		<xsl:for-each select="laneSets">
			<xsl:for-each select="lanes">
				<bpmndi:BPMNShape>
					<xsl:attribute name="id">
						<xsl:text>BPMNShape_Lane_</xsl:text>
						<xsl:value-of select="@id"></xsl:value-of> 	
					</xsl:attribute>
					<xsl:attribute name="bpmnElement">
						<xsl:value-of select="@id" />
					...
					<dc:Bounds>
						...
						<xsl:attribute name="y">
							...
							<xsl:value-of select="((number($num) -1 )* 200)+ 100 " />
						</xsl:attribute>
					</dc:Bounds>
				</bpmndi:BPMNShape>
				<!-- create elements belonging to the lane -->
				<xsl:call-template name="flowNodesCreation">
					<xsl:with-param name="y" select="(position() -1 )* 200 + 100"></xsl:with-param>
					<xsl:with-param name="list" select="@flowNodeRefs"></xsl:with-param>
				</xsl:call-template>
			</xsl:for-each>
		</xsl:for-each>
		...
		<xsl:for-each select="flowElements">
			...
			<xsl:when
					...
					<bpmndi:BPMNShape>
						<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_CallActivity_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
						<xsl:attribute name="bpmnElement">
        			 <xsl:value-of select="@id"></xsl:value-of>
						...
						<dc:Bounds>
							...
							<xsl:attribute name="width">
        			 			<xsl:text>110.0</xsl:text>
        			 		</xsl:attribute>
							<xsl:attribute name="x">
        						<xsl:variable name="num">
        							<xsl:number expr="position()" />
        						</xsl:variable>
        						<xsl:value-of select="(number($num) * 50) + 150 " />
        			 		</xsl:attribute>
							<xsl:attribute name="y">
        			 			<xsl:text>175.0</xsl:text>
        			 		</xsl:attribute>
						</dc:Bounds>
					</bpmndi:BPMNShape>
				</xsl:when>
				<xsl:when
					...
					<bpmndi:BPMNEdge>
						<xsl:attribute name="id">
        			 	  <xsl:text>BPMNEdge_SequenceFlow_</xsl:text>
        				  <xsl:value-of select="@id"></xsl:value-of> 	
        			 	</xsl:attribute>
						<xsl:attribute name="bpmnElement">
        			 		<xsl:value-of select="@id"></xsl:value-of> 		
						...
						<di:waypoint xsi:type="dc:Point">
							<xsl:attribute name="x">
					<xsl:value-of select="$coordinates"></xsl:value-of> 
						</xsl:attribute>
							<xsl:attribute name="y">
						<xsl:value-of select="$coordinates"></xsl:value-of> 
						</xsl:attribute>
					...
					<xsl:call-template name="createThrowEventVsGateway">
						<xsl:with-param name="sourceId" select="@sourceRef" />
						<xsl:with-param name="targetId" select="@targetRef" />
					</xsl:call-template>

					<xsl:call-template name="createCatchEventVsGateway">
						<xsl:with-param name="sourceId" select="@sourceRef" />
						<xsl:with-param name="targetId" select="@targetRef" />
					</xsl:call-template>
				</xsl:when>
				<xsl:when
					...
					<bpmndi:BPMNShape>
						<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_DataObject_</xsl:text>
						...
						<dc:Bounds>
							<xsl:attribute name="height">
        			 			<xsl:text>65.0</xsl:text>
        			 		</xsl:attribute>
							<xsl:attribute name="width">
        			 			<xsl:text>36.0</xsl:text>
        			 		</xsl:attribute>
							<xsl:attribute name="x">
        						<xsl:variable name="num">
        							<xsl:number expr="position()" />
				...
				<xsl:when test="substring-after(@xsi:type, ':') = 'ParallelGateway'">
					<bpmndi:BPMNShape>
						<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_ParallelGateway_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
						<xsl:attribute name="bpmnElement">
        			 	<xsl:value-of select="@id"></xsl:value-of>
						...
						<dc:Bounds>
							...
							<xsl:attribute name="y">
        			 			<xsl:value-of select="175"></xsl:value-of>
        			 		</xsl:attribute>
						</dc:Bounds>
					</bpmndi:BPMNShape>
				</xsl:when>
				<xsl:when test="substring-after(@xsi:type, ':') = 'ExclusiveGateway'">
					<bpmndi:BPMNShape>
						<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_ExclusiveGateway_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
						<xsl:attribute name="bpmnElement">
        			 	<xsl:value-of select="@id"></xsl:value-of>
		...
		<xsl:for-each select="artifacts">
			<xsl:choose>
				<xsl:when
					...
					<bpmndi:BPMNEdge>
						<xsl:attribute name="id">
        			 	  <xsl:text>BPMNEdge_Association_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
						<xsl:attribute name="bpmnElement">
        			 		<xsl:value-of select="@id"></xsl:value-of> 		
	...
	<xsl:template name="DiagramTemplate">
		<xsl:call-template name="SplitString">
			...
			<xsl:with-param name="elementNamespace"
				select="'http://www.omg.org/spec/DD/20100524/DI'" />
		</xsl:call-template>
	...
	<xsl:template name="PlaneTemplate">
		...
		<xsl:for-each select="planeElement">
			<xsl:choose>
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'BPMNEdge' or substring-after(@xsi:type, ':') = 'BPMNEdge'">
					<bpmndi:BPMNEdge>
				...
				<xsl:when
					test="substring-after(@xmi:type, ':') = 'BPMNShape' or substring-after(@xsi:type, ':') = 'BPMNShape'">
					<bpmndi:BPMNShape>
	...
	<!-- create flowElements in a lane -->
	<xsl:template name="flowNodesCreation">
		<xsl:param name="y"></xsl:param>
		<xsl:param name="list"></xsl:param>

		<!-- create userTask, serviceTask or subProcess  -->
		<xsl:for-each select="//flowElements[contains($list,@id)]">
			<xsl:choose>
				<xsl:when test="substring-after(@xsi:type, ':') = 'SubProcess' ">
					<bpmndi:BPMNShape>
						<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_SubProcess_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
						<xsl:attribute name="bpmnElement">
        			 		<xsl:value-of select="@id"></xsl:value-of>
				...
				<xsl:when
					...
					<bpmndi:BPMNShape>
						<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_BusinessRuleTask_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
						<xsl:attribute name="bpmnElement">
        			 	<xsl:value-of select="@id"></xsl:value-of>
				...
				<xsl:when
					...
					<bpmndi:BPMNShape>
						<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_Task_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
						<xsl:attribute name="bpmnElement">
        			 	<xsl:value-of select="@id"></xsl:value-of>
				...
				<xsl:when
					...
					<bpmndi:BPMNShape>
						<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_ServiceTask_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
						<xsl:attribute name="bpmnElement">
        			<xsl:value-of select="@id"></xsl:value-of>
		...
		<!-- create dataObjects -->
 		<!-- <xsl:for-each select="//artifacts[contains($list,@targetRef)]">
			<xsl:call-template name="createDataObject">
				<xsl:with-param name="y" select="$y"></xsl:with-param>
				<xsl:with-param name="objectId" select="@sourceRef"></xsl:with-param>
				<xsl:with-param name="cont" select="@id"></xsl:with-param>
			</xsl:call-template>
		</xsl:for-each>  -->
		
	
		<!-- create start or catch events -->
		<xsl:for-each select="//flowElements[contains($list,@targetRef)]">
			<xsl:call-template name="createStartOrCatchEvent">
				<xsl:with-param name="y" select="$y"></xsl:with-param>
				<xsl:with-param name="objectId" select="@sourceRef"></xsl:with-param>
			</xsl:call-template>
		</xsl:for-each>
		<!-- create end or throw events -->
		<xsl:for-each select="//flowElements[contains($list,@sourceRef)]">
			<xsl:call-template name="createEndOrThrowEvent">
				<xsl:with-param name="y" select="$y"></xsl:with-param>
				<xsl:with-param name="objectId" select="@targetRef"></xsl:with-param>
			</xsl:call-template>
		</xsl:for-each>
	</xsl:template>

	<xsl:template name="createDataObject">
		<xsl:param name="y"></xsl:param>
		<xsl:param name="objectId"></xsl:param>
		<xsl:param name="cont"></xsl:param>

		<xsl:for-each select="//flowElements[@id=$objectId]">
			<xsl:choose>
				<xsl:when test="substring-after(@xsi:type, ':') = 'DataObject'">
					<bpmndi:BPMNShape>
						<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_DataObject_</xsl:text>
        				  <xsl:value-of select="$cont"></xsl:value-of>
        			 	</xsl:attribute>
						<xsl:attribute name="bpmnElement">
        			 	<xsl:value-of select="@id"></xsl:value-of>
        			 	</xsl:attribute>
	...
	<xsl:template name="createEndOrThrowEvent">
		<xsl:param name="y"></xsl:param>
		<xsl:param name="objectId"></xsl:param>
		...
		<xsl:for-each select="//flowElements[@id=$objectId]">
			<xsl:choose>
				<xsl:when test="substring-after(@xsi:type, ':') = 'EndEvent'">
					<bpmndi:BPMNShape>
						<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_EndEvent_</xsl:text>
        				  <xsl:value-of select="@id"></xsl:value-of> 	
        			 	</xsl:attribute>
						<xsl:attribute name="bpmnElement">
        			 		<xsl:value-of select="@id"></xsl:value-of>
	...
	<xsl:template name="createStartOrCatchEvent">
		<xsl:param name="y"></xsl:param>
		<xsl:param name="objectId"></xsl:param>
	...
	<xsl:template name="CreateOutputMessageFlow">
		<xsl:param name="idOfSource"></xsl:param>
		<xsl:param name="x"></xsl:param>
		<xsl:param name="y"></xsl:param>

		<xsl:for-each select="//messageFlows[@sourceRef=$idOfSource]">
			<bpmndi:BPMNEdge>
				<xsl:attribute name="id">
        			 	  <xsl:text>BPMNEdge_messageFlows_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
				<xsl:attribute name="bpmnElement">
        			 		<xsl:value-of select="@id"></xsl:value-of> 		
				...
				<di:waypoint xsi:type="dc:Point">
					...
					<xsl:attribute name="y"><xsl:value-of
						select="$y"></xsl:value-of>
										</xsl:attribute>
				</di:waypoint>
				<di:waypoint xsi:type="dc:Point">
					<xsl:attribute name="x"><xsl:text>12.0</xsl:text>
										</xsl:attribute>
					<xsl:attribute name="y"><xsl:text>12.0</xsl:text>
										</xsl:attribute>
				</di:waypoint>
			</bpmndi:BPMNEdge>
		</xsl:for-each>
	...
	<xsl:template name="CreateInputMessageFlow">
		<xsl:param name="idOfTarget"></xsl:param>
		<xsl:param name="x"></xsl:param>
		<xsl:param name="y"></xsl:param>

		<xsl:for-each select="//messageFlows[@targetRef=$idOfTarget]">
			<bpmndi:BPMNEdge>
				<xsl:attribute name="id">
        			 	  <xsl:text>BPMNEdge_messageFlows_</xsl:text>
        				  <xsl:number expr="position()" />
	...
	<xsl:template name="createThrowEventVsGateway">
		<xsl:param name="sourceId"></xsl:param>
		<xsl:param name="targetId"></xsl:param>

		<xsl:for-each select="//flowElements[@id = $sourceId]">
			<xsl:if
				test="substring-after(@xsi:type, ':') != 'UserTask' and substring-after(@xsi:type, ':') != 'ServiceTask' and substring-after(@xsi:type, ':') != 'SubProcess'">
				<xsl:for-each select="//flowElements[@id = $targetId]">
					<xsl:if
						test="substring-after(@xsi:type, ':') = 'IntermediateThrowEvent' ">
						<bpmndi:BPMNShape>
							<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_ThrowEvent_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
							<xsl:attribute name="bpmnElement">
        			 <xsl:value-of select="@id"></xsl:value-of>
	...
	<xsl:template name="createCatchEventVsGateway">
		<xsl:param name="sourceId"></xsl:param>
		<xsl:param name="targetId"></xsl:param>
		...
		<xsl:for-each select="//flowElements[@id = $targetId]">
			<xsl:if
				...
				<xsl:for-each select="//flowElements[@id = $sourceId]">
					<xsl:if
						test="substring-after(@xsi:type, ':') = 'IntermediateCatchEvent' ">
						<bpmndi:BPMNShape>
							<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_CatchEvent_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
							<xsl:attribute name="bpmnElement">
        			 <xsl:value-of select="@id"></xsl:value-of>
