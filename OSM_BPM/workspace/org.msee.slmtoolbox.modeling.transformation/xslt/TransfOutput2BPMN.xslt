			...
			<xsl:when test="substring-after(@xmi:type, ':') = 'Process' or substring-after(@xsi:type, ':') = 'Process'">
				...
				<bpmndi:BPMNPlane>
						...
						<xsl:choose>
							<xsl:when
        			 		...
        			 		<xsl:number expr="position()" />
        						...
        						<xsl:value-of select="(number($num) * 70.0)+100.0 " />
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
        				  ...
        				  <xsl:number expr="position()" />
									...
									<xsl:attribute name="bpmnElement">
        			 		<xsl:text>ExclusiveGateway_</xsl:text>
        			 		<xsl:number expr="position()" />
        			 	</xsl:attribute>
									<dc:Bounds>
										<xsl:attribute name="height">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
							<xsl:when
								...
								<bpmndi:BPMNShape>
									<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_InclusiveGateway_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
									<xsl:attribute name="bpmnElement">
        			 		<xsl:text>InclusiveGateway_</xsl:text>
        			 		<xsl:number expr="position()" />
        			 	</xsl:attribute>
									<dc:Bounds>
										<xsl:attribute name="height">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
        				  ...
        				  <xsl:number expr="position()" />
									...
									<xsl:attribute name="bpmnElement">
        			 		<xsl:text>ParallelGateway_</xsl:text>
        			 		<xsl:number expr="position()" />
        			 	</xsl:attribute>
									<dc:Bounds>
										<xsl:attribute name="height">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
							<xsl:when
								...
								<bpmndi:BPMNShape>
									<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_ScriptTask_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
									<xsl:attribute name="bpmnElement">
        			 		<xsl:text>ScriptTask_</xsl:text>
        			 		<xsl:number expr="position()" />
        			 	</xsl:attribute>
									<dc:Bounds>
										<xsl:attribute name="height">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
        				  ...
        				  <xsl:number expr="position()" />
									...
									<xsl:attribute name="bpmnElement">
        			 		<xsl:text>BusinessRuleTask_</xsl:text>
        			 		<xsl:number expr="position()" />
        			 	</xsl:attribute>
									<dc:Bounds>
										<xsl:attribute name="height">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
        				  ...
        				  <xsl:number expr="position()" />
									...
									<xsl:attribute name="bpmnElement">
        			 		<xsl:text>ServiceTask_</xsl:text>
        			 		<xsl:number expr="position()" />
        			 	</xsl:attribute>
									<dc:Bounds>
										<xsl:attribute name="height">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
							<xsl:when
								...
								<bpmndi:BPMNShape>
									<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_SendTask_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
									<xsl:attribute name="bpmnElement">
        			 		<xsl:text>SendTask_</xsl:text>
        			 		<xsl:number expr="position()" />
        			 	</xsl:attribute>
									<dc:Bounds>
										<xsl:attribute name="height">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
							<xsl:when
								...
								<bpmndi:BPMNShape>
									<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_ReceiveTask_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
									<xsl:attribute name="bpmnElement">
        			 		<xsl:text>ReceiveTask_</xsl:text>
        			 		<xsl:number expr="position()" />
        			 	</xsl:attribute>
									<dc:Bounds>
										<xsl:attribute name="height">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
							<xsl:when
								test="substring-after(@xmi:type, ':') = 'ThrowEvent' or substring-after(@xsi:type, ':') = 'ThrowEvent'">
								<bpmndi:BPMNShape>
									<xsl:attribute name="id">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
							<xsl:when
								test="substring-after(@xmi:type, ':') = 'CatchEvent' or substring-after(@xsi:type, ':') = 'CatchEvent'">
								<bpmndi:BPMNShape>
									<xsl:attribute name="id">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
							<xsl:when
								...
								<bpmndi:BPMNShape>
									<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_BoundaryEvent_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
									<xsl:attribute name="bpmnElement">
        			 		<xsl:text>BoundaryEvent_</xsl:text>
        			 		<xsl:number expr="position()" />
        			 	</xsl:attribute>
									<dc:Bounds>
										<xsl:attribute name="height">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
							<xsl:when
								test="substring-after(@xmi:type, ':') = 'DataInput' or substring-after(@xsi:type, ':') = 'DataInput'">
								<bpmndi:BPMNShape>
									<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_DataInput_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
									<xsl:attribute name="bpmnElement">
        			 		<xsl:text>DataInput_</xsl:text>
        			 		<xsl:number expr="position()" />
        			 	</xsl:attribute>
									<dc:Bounds>
										<xsl:attribute name="height">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
							<xsl:when
								test="substring-after(@xmi:type, ':') = 'DataOutput' or substring-after(@xsi:type, ':') = 'DataOutput'">
								<bpmndi:BPMNShape>
									<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_DataOutput_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
									<xsl:attribute name="bpmnElement">
        			 		<xsl:text>DataOutput_</xsl:text>
        			 		<xsl:number expr="position()" />
        			 	</xsl:attribute>
									<dc:Bounds>
										<xsl:attribute name="height">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
							<xsl:when
								...
								<bpmndi:BPMNShape>
									<xsl:attribute name="id">
        			 	  <xsl:text>BPMNShape_Message_</xsl:text>
        				  <xsl:number expr="position()" />
        			 	</xsl:attribute>
									<xsl:attribute name="bpmnElement">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
        				  ...
        				  <xsl:number expr="position()" />
									...
									<xsl:attribute name="bpmnElement">
        			 		<xsl:text>CallActivity_</xsl:text>
        			 		<xsl:number expr="position()" />
        			 	</xsl:attribute>
									<dc:Bounds>
										<xsl:attribute name="height">
					...
					<xsl:for-each select="flowElements">
						<xsl:choose>
							<xsl:when
								test="substring-after(@xmi:type, ':') = 'SubProcess' or substring-after(@xsi:type, ':') = 'SequenceFlow'">
								<bpmndi:BPMNEdge>
									<xsl:attribute name="id">
        				  ...
        				  <xsl:number expr="position()" />
									...
									<xsl:attribute name="bpmnElement">
        			 		<xsl:text>SequenceFlow_</xsl:text>
        			 		<xsl:number expr="position()" />
        			 	</xsl:attribute>
