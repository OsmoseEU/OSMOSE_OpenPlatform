...
import org.msee.slmtoolbox.modeling.model.ssm.bsm.dialogs.BsmAddPIToObjectiveDialog;
 ...
 * 
 */
public class BsmDecisionObjectivePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, BsmDecisionObjectivePropertiesEditionPart {
	 ...
	 */
	public BsmDecisionObjectivePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public BsmDecisionObjectivePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(BsmMessages.BsmDecisionObjectivePropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							BsmDecisionObjectivePropertiesEditionPartForm.this,
							BsmViewsRepository.BsmDecisionObjective.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmDecisionObjectivePropertiesEditionPartForm.this, BsmViewsRepository.BsmDecisionObjective.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, BsmViewsRepository.BsmDecisionObjective.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmDecisionObjective.Properties.name, BsmViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							BsmDecisionObjectivePropertiesEditionPartForm.this,
							BsmViewsRepository.BsmDecisionObjective.Properties.description,
		...
		description.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmDecisionObjectivePropertiesEditionPartForm.this, BsmViewsRepository.BsmDecisionObjective.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
				}
			}
		});
		EditingUtils.setID(description, BsmViewsRepository.BsmDecisionObjective.Properties.description);
		EditingUtils.setEEFtype(description, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmDecisionObjective.Properties.description, BsmViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createDecisionFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		decision = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(BsmViewsRepository.BsmDecisionObjective.Properties.decision, BsmViewsRepository.FORM_KIND));
		...
		decision.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmDecisionObjectivePropertiesEditionPartForm.this, BsmViewsRepository.BsmDecisionObjective.Properties.decision, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getDecision()));
			}

		});
		decision.setID(BsmViewsRepository.BsmDecisionObjective.Properties.decision);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmDecisionObjective.Properties.decision, BsmViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createPerformanceIndicatorsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.performanceIndicators = new ReferencesTable(getDescription(BsmViewsRepository.BsmDecisionObjective.Properties.performanceIndicators, BsmMessages.BsmDecisionObjectivePropertiesEditionPart_PerformanceIndicatorsLabel), new ReferencesTableListener	() {
		...
		this.performanceIndicators.setHelpText(propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmDecisionObjective.Properties.performanceIndicators, BsmViewsRepository.FORM_KIND));
		...
		this.performanceIndicators.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmDecisionObjectivePropertiesEditionPartForm.this, BsmViewsRepository.BsmDecisionObjective.Properties.performanceIndicators, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addPerformanceIndicators() {
		// Start of user code
		BsmAddPIToObjectiveDialog dialog = new BsmAddPIToObjectiveDialog(PlatformUI.getWorkbench().getDisplay().getActiveShell(), performanceIndicators.getLabelProvider(), (BsmDecisionObjective) ((ReferencesTableSettings)this.performanceIndicators.getInput()).getSource());		
		dialog.open();
	...
	protected void movePerformanceIndicators(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmDecisionObjectivePropertiesEditionPartForm.this, BsmViewsRepository.BsmDecisionObjective.Properties.performanceIndicators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		performanceIndicators.refresh();
	}
	...
	protected void removeFromPerformanceIndicators(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmDecisionObjectivePropertiesEditionPartForm.this, BsmViewsRepository.BsmDecisionObjective.Properties.performanceIndicators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		performanceIndicators.refresh();
	}
