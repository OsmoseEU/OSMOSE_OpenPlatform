 ...
 * 
 */
public class BsmPartnerPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, BsmPartnerPropertiesEditionPart {
	 ...
	 * 
	 */
	public BsmPartnerPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(bsmPartnerStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == BsmViewsRepository.BsmPartner.Properties.competence) {
					return createCompetenceText(parent);
				}
				if (key == BsmViewsRepository.BsmPartner.Properties.concern) {
					return createConcernText(parent);
				}
				...
				if (key == BsmViewsRepository.BsmPartner.Properties.contribution) {
					return createContributionText(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(BsmMessages.BsmPartnerPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmPartnerPropertiesEditionPartImpl.this, BsmViewsRepository.BsmPartner.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmPartner.Properties.name, BsmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createCategoryText(Composite parent) {
		...
		category = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		category.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmPartnerPropertiesEditionPartImpl.this, BsmViewsRepository.BsmPartner.Properties.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, category.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmPartner.Properties.category, BsmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createCompetenceText(Composite parent) {
		...
		competence = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		competence.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmPartnerPropertiesEditionPartImpl.this, BsmViewsRepository.BsmPartner.Properties.competence, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, competence.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmPartner.Properties.competence, BsmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createConcernText(Composite parent) {
		...
		concern = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		concern.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmPartnerPropertiesEditionPartImpl.this, BsmViewsRepository.BsmPartner.Properties.concern, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, concern.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmPartner.Properties.concern, BsmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createConstraintText(Composite parent) {
		...
		constraint.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmPartnerPropertiesEditionPartImpl.this, BsmViewsRepository.BsmPartner.Properties.constraint, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, constraint.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmPartner.Properties.constraint, BsmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createContributionText(Composite parent) {
		...
		contribution = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		contribution.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmPartnerPropertiesEditionPartImpl.this, BsmViewsRepository.BsmPartner.Properties.contribution, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, contribution.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmPartner.Properties.contribution, BsmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
