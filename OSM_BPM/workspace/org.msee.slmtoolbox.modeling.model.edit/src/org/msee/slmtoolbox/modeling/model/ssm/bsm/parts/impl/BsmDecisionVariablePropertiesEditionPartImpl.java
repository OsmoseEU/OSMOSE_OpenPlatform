 ...
 * 
 */
public class BsmDecisionVariablePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, BsmDecisionVariablePropertiesEditionPart {
	 ...
	 * 
	 */
	public BsmDecisionVariablePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(BsmMessages.BsmDecisionVariablePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmDecisionVariablePropertiesEditionPartImpl.this, BsmViewsRepository.BsmDecisionVariable.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmDecisionVariable.Properties.name, BsmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createDescriptionText(Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmDecisionVariablePropertiesEditionPartImpl.this, BsmViewsRepository.BsmDecisionVariable.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmDecisionVariable.Properties.description, BsmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createDecisionFlatComboViewer(Composite parent) {
		...
		decision = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(BsmViewsRepository.BsmDecisionVariable.Properties.decision, BsmViewsRepository.SWT_KIND));
		...
		decision.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmDecisionVariablePropertiesEditionPartImpl.this, BsmViewsRepository.BsmDecisionVariable.Properties.decision, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getDecision()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmDecisionVariable.Properties.decision, BsmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createPerformanceIndicatorsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(BsmViewsRepository.BsmDecisionVariable.Properties.performanceIndicators, BsmMessages.BsmDecisionVariablePropertiesEditionPart_PerformanceIndicatorsLabel);		 
		...
		this.performanceIndicators.setHelpText(propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmDecisionVariable.Properties.performanceIndicators, BsmViewsRepository.SWT_KIND));
		...
		this.performanceIndicators.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmDecisionVariablePropertiesEditionPartImpl.this, BsmViewsRepository.BsmDecisionVariable.Properties.performanceIndicators, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"performanceIndicators", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmDecisionVariablePropertiesEditionPartImpl.this, BsmViewsRepository.BsmDecisionVariable.Properties.performanceIndicators,
	...
	protected void movePerformanceIndicators(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmDecisionVariablePropertiesEditionPartImpl.this, BsmViewsRepository.BsmDecisionVariable.Properties.performanceIndicators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		performanceIndicators.refresh();
	}
	...
	protected void removeFromPerformanceIndicators(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmDecisionVariablePropertiesEditionPartImpl.this, BsmViewsRepository.BsmDecisionVariable.Properties.performanceIndicators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		performanceIndicators.refresh();
	}
