 ...
 * 
 */
public class EaOrganizationPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, EaOrganizationPropertiesEditionPart {
	 ...
	 */
	public EaOrganizationPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public EaOrganizationPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(eaOrganizationStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == CoreElementsViewsRepository.EaOrganization.Properties.flowNode) {
					return createFlowNodeReferencesTable(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(CoreElementsMessages.EaOrganizationPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EaOrganizationPropertiesEditionPartForm.this,
							CoreElementsViewsRepository.EaOrganization.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaOrganizationPropertiesEditionPartForm.this, CoreElementsViewsRepository.EaOrganization.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, CoreElementsViewsRepository.EaOrganization.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(CoreElementsViewsRepository.EaOrganization.Properties.name, CoreElementsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createCodeText(FormToolkit widgetFactory, Composite parent) {
		...
		code.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EaOrganizationPropertiesEditionPartForm.this,
							CoreElementsViewsRepository.EaOrganization.Properties.code,
		...
		code.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaOrganizationPropertiesEditionPartForm.this, CoreElementsViewsRepository.EaOrganization.Properties.code, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, code.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(CoreElementsViewsRepository.EaOrganization.Properties.code, CoreElementsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EaOrganizationPropertiesEditionPartForm.this,
							CoreElementsViewsRepository.EaOrganization.Properties.description,
		...
		description.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaOrganizationPropertiesEditionPartForm.this, CoreElementsViewsRepository.EaOrganization.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
				}
			}
		});
		EditingUtils.setID(description, CoreElementsViewsRepository.EaOrganization.Properties.description);
		EditingUtils.setEEFtype(description, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(CoreElementsViewsRepository.EaOrganization.Properties.description, CoreElementsViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createFlowNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.flowNode = new ReferencesTable(getDescription(CoreElementsViewsRepository.EaOrganization.Properties.flowNode, CoreElementsMessages.EaOrganizationPropertiesEditionPart_FlowNodeLabel), new ReferencesTableListener	() {
		...
		this.flowNode.setHelpText(propertiesEditionComponent.getHelpContent(CoreElementsViewsRepository.EaOrganization.Properties.flowNode, CoreElementsViewsRepository.FORM_KIND));
		this.flowNode.createControls(parent, widgetFactory);
		this.flowNode.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaOrganizationPropertiesEditionPartForm.this, CoreElementsViewsRepository.EaOrganization.Properties.flowNode, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"flowNode", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaOrganizationPropertiesEditionPartForm.this, CoreElementsViewsRepository.EaOrganization.Properties.flowNode,
	...
	protected void moveFlowNode(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaOrganizationPropertiesEditionPartForm.this, CoreElementsViewsRepository.EaOrganization.Properties.flowNode, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		flowNode.refresh();
	}
	...
	protected void removeFromFlowNode(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaOrganizationPropertiesEditionPartForm.this, CoreElementsViewsRepository.EaOrganization.Properties.flowNode, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		flowNode.refresh();
	}
