 ...
 * 
 */
public class TimMessages extends NLS {
	
	private static final String BUNDLE_NAME = "org.msee.slmtoolbox.modeling.model.ssm.tim.providers.timMessages"; //$NON-NLS-1$

	
	public static String TimModelPropertiesEditionPart_PropertiesGroupLabel;


	
	public static String TimModel_ReadOnly;

	
	public static String TimModel_Part_Title;


	
	public static String TimModelPropertiesEditionPart_NameLabel;

	
	public static String TimModelPropertiesEditionPart_ResourcesLabel;
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, TimMessages.class);
	}
