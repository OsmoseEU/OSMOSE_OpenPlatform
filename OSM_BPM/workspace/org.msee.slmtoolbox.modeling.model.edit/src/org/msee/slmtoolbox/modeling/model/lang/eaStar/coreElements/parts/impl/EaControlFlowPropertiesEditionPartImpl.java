 ...
 * 
 */
public class EaControlFlowPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EaControlFlowPropertiesEditionPart {
	 ...
	 * 
	 */
	public EaControlFlowPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(CoreElementsMessages.EaControlFlowPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaControlFlowPropertiesEditionPartImpl.this, CoreElementsViewsRepository.EaControlFlow.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(CoreElementsViewsRepository.EaControlFlow.Properties.name, CoreElementsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createCodeText(Composite parent) {
		...
		code.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaControlFlowPropertiesEditionPartImpl.this, CoreElementsViewsRepository.EaControlFlow.Properties.code, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, code.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(CoreElementsViewsRepository.EaControlFlow.Properties.code, CoreElementsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createDescriptionText(Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaControlFlowPropertiesEditionPartImpl.this, CoreElementsViewsRepository.EaControlFlow.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(CoreElementsViewsRepository.EaControlFlow.Properties.description, CoreElementsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createIsTriggerCheckbox(Composite parent) {
		...
		isTrigger.setText(getDescription(CoreElementsViewsRepository.EaControlFlow.Properties.isTrigger, CoreElementsMessages.EaControlFlowPropertiesEditionPart_IsTriggerLabel));
		isTrigger.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaControlFlowPropertiesEditionPartImpl.this, CoreElementsViewsRepository.EaControlFlow.Properties.isTrigger, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isTrigger.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(CoreElementsViewsRepository.EaControlFlow.Properties.isTrigger, CoreElementsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createTriggerInfoText(Composite parent) {
		...
		triggerInfo.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaControlFlowPropertiesEditionPartImpl.this, CoreElementsViewsRepository.EaControlFlow.Properties.triggerInfo, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, triggerInfo.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(CoreElementsViewsRepository.EaControlFlow.Properties.triggerInfo, CoreElementsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createSourceText(Composite parent) {
		...
		source.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaControlFlowPropertiesEditionPartImpl.this, CoreElementsViewsRepository.EaControlFlow.Properties.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, source.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(CoreElementsViewsRepository.EaControlFlow.Properties.source, CoreElementsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createTargetText(Composite parent) {
		...
		target.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EaControlFlowPropertiesEditionPartImpl.this, CoreElementsViewsRepository.EaControlFlow.Properties.target, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, target.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(CoreElementsViewsRepository.EaControlFlow.Properties.target, CoreElementsViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
