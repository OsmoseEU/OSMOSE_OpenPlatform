 ...
 *
 */
public class BsmAddDecisionToOrganizationDialog extends AbstractBsmElementDialog<BsmOrganization, BsmDecision> {
	 ...
	 * 
	 */
	public BsmAddDecisionToOrganizationDialog(Shell parentShell, ILabelProvider labelProvider,
			BsmOrganization organization) {
		super(parentShell, labelProvider, organization, "String Selection", "Select a String (* = any string, ? = any char):", BsmDecision.class);
	}
