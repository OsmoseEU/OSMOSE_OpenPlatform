 ...
 * 
 */
public class BsmVirtualEnterprisePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, BsmVirtualEnterprisePropertiesEditionPart {
	 ...
	 */
	public BsmVirtualEnterprisePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public BsmVirtualEnterprisePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(BsmMessages.BsmVirtualEnterprisePropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							BsmVirtualEnterprisePropertiesEditionPartForm.this,
							BsmViewsRepository.BsmVirtualEnterprise.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, BsmViewsRepository.BsmVirtualEnterprise.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmVirtualEnterprise.Properties.name, BsmViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							BsmVirtualEnterprisePropertiesEditionPartForm.this,
							BsmViewsRepository.BsmVirtualEnterprise.Properties.description,
		...
		description.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
				}
			}
		});
		EditingUtils.setID(description, BsmViewsRepository.BsmVirtualEnterprise.Properties.description);
		EditingUtils.setEEFtype(description, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmVirtualEnterprise.Properties.description, BsmViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createProcessesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.processes = new ReferencesTable(getDescription(BsmViewsRepository.BsmVirtualEnterprise.Properties.processes, BsmMessages.BsmVirtualEnterprisePropertiesEditionPart_ProcessesLabel), new ReferencesTableListener	() {
		...
		this.processes.setHelpText(propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmVirtualEnterprise.Properties.processes, BsmViewsRepository.FORM_KIND));
		...
		this.processes.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.processes, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void moveProcesses(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.processes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		processes.refresh();
	}
	...
	protected void removeFromProcesses(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.processes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		processes.refresh();
	}
	...
	protected Composite createDecisionsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.decisions = new ReferencesTable(getDescription(BsmViewsRepository.BsmVirtualEnterprise.Properties.decisions, BsmMessages.BsmVirtualEnterprisePropertiesEditionPart_DecisionsLabel), new ReferencesTableListener	() {
		...
		this.decisions.setHelpText(propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmVirtualEnterprise.Properties.decisions, BsmViewsRepository.FORM_KIND));
		this.decisions.createControls(parent, widgetFactory);
		this.decisions.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.decisions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void moveDecisions(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.decisions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		decisions.refresh();
	}
	...
	protected void removeFromDecisions(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.decisions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		decisions.refresh();
	}
	...
	protected Composite createDecisionStructuresReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.decisionStructures = new ReferencesTable(getDescription(BsmViewsRepository.BsmVirtualEnterprise.Properties.decisionStructures, BsmMessages.BsmVirtualEnterprisePropertiesEditionPart_DecisionStructuresLabel), new ReferencesTableListener	() {
		...
		this.decisionStructures.setHelpText(propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmVirtualEnterprise.Properties.decisionStructures, BsmViewsRepository.FORM_KIND));
		...
		this.decisionStructures.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.decisionStructures, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"decisionStructures", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.decisionStructures,
	...
	protected void moveDecisionStructures(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.decisionStructures, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		decisionStructures.refresh();
	}
	...
	protected void removeFromDecisionStructures(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.decisionStructures, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		decisionStructures.refresh();
	}
	...
	protected Composite createGgOrganizationsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.ggOrganizations = new ReferencesTable(getDescription(BsmViewsRepository.BsmVirtualEnterprise.Properties.ggOrganizations, BsmMessages.BsmVirtualEnterprisePropertiesEditionPart_GgOrganizationsLabel), new ReferencesTableListener	() {
		...
		this.ggOrganizations.setHelpText(propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmVirtualEnterprise.Properties.ggOrganizations, BsmViewsRepository.FORM_KIND));
		this.ggOrganizations.createControls(parent, widgetFactory);
		this.ggOrganizations.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.ggOrganizations, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addGgOrganizations() {
		...
		"ggOrganizations", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.ggOrganizations,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveGgOrganizations(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.ggOrganizations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		ggOrganizations.refresh();
	}
	...
	protected void removeFromGgOrganizations(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.ggOrganizations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		ggOrganizations.refresh();
	}
	...
	protected Composite createEaOrganizationsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.eaOrganizations = new ReferencesTable(getDescription(BsmViewsRepository.BsmVirtualEnterprise.Properties.eaOrganizations, BsmMessages.BsmVirtualEnterprisePropertiesEditionPart_EaOrganizationsLabel), new ReferencesTableListener	() {
		...
		this.eaOrganizations.setHelpText(propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmVirtualEnterprise.Properties.eaOrganizations, BsmViewsRepository.FORM_KIND));
		this.eaOrganizations.createControls(parent, widgetFactory);
		this.eaOrganizations.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.eaOrganizations, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addEaOrganizations() {
		...
		"eaOrganizations", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.eaOrganizations,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveEaOrganizations(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.eaOrganizations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		eaOrganizations.refresh();
	}
	...
	protected void removeFromEaOrganizations(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.eaOrganizations, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		eaOrganizations.refresh();
	}
	...
	protected Composite createMseServiceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.mseService = new ReferencesTable(getDescription(BsmViewsRepository.BsmVirtualEnterprise.Properties.mseService, BsmMessages.BsmVirtualEnterprisePropertiesEditionPart_MseServiceLabel), new ReferencesTableListener	() {
		...
		this.mseService.setHelpText(propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmVirtualEnterprise.Properties.mseService, BsmViewsRepository.FORM_KIND));
		this.mseService.createControls(parent, widgetFactory);
		this.mseService.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.mseService, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addMseService() {
		...
		"mseService", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.mseService,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				mseService.refresh();
			}
	...
	protected void moveMseService(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.mseService, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		mseService.refresh();
	}
	...
	protected void removeFromMseService(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.mseService, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		mseService.refresh();
	}
	...
	protected Composite createTypeText(FormToolkit widgetFactory, Composite parent) {
		...
		type.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							BsmVirtualEnterprisePropertiesEditionPartForm.this,
							BsmViewsRepository.BsmVirtualEnterprise.Properties.type,
		...
		type.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmVirtualEnterprisePropertiesEditionPartForm.this, BsmViewsRepository.BsmVirtualEnterprise.Properties.type, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, type.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmVirtualEnterprise.Properties.type, BsmViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
