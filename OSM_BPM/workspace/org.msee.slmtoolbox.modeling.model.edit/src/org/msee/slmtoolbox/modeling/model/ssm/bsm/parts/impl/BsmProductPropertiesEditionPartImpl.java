 ...
 * 
 */
public class BsmProductPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, BsmProductPropertiesEditionPart {
	 ...
	 * 
	 */
	public BsmProductPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(bsmProductStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == BsmViewsRepository.BsmProduct.Properties.techCharacteristics) {
					return createTechCharacteristicsText(parent);
				}
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(BsmMessages.BsmProductPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmProductPropertiesEditionPartImpl.this, BsmViewsRepository.BsmProduct.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmProduct.Properties.name, BsmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createTypeText(Composite parent) {
		...
		type.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmProductPropertiesEditionPartImpl.this, BsmViewsRepository.BsmProduct.Properties.type, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, type.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmProduct.Properties.type, BsmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createFunctionText(Composite parent) {
		...
		function.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmProductPropertiesEditionPartImpl.this, BsmViewsRepository.BsmProduct.Properties.function, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, function.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmProduct.Properties.function, BsmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createTechCharacteristicsText(Composite parent) {
		...
		techCharacteristics = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		techCharacteristics.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmProductPropertiesEditionPartImpl.this, BsmViewsRepository.BsmProduct.Properties.techCharacteristics, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, techCharacteristics.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmProduct.Properties.techCharacteristics, BsmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createFunctionalitiesAdvancedReferencesTable(Composite parent) {
		String label = getDescription(BsmViewsRepository.BsmProduct.Properties.functionalities, BsmMessages.BsmProductPropertiesEditionPart_FunctionalitiesLabel);		 
		...
		this.functionalities.setHelpText(propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmProduct.Properties.functionalities, BsmViewsRepository.SWT_KIND));
		...
		this.functionalities.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmProductPropertiesEditionPartImpl.this, BsmViewsRepository.BsmProduct.Properties.functionalities, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"functionalities", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmProductPropertiesEditionPartImpl.this, BsmViewsRepository.BsmProduct.Properties.functionalities,
	...
	protected void moveFunctionalities(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmProductPropertiesEditionPartImpl.this, BsmViewsRepository.BsmProduct.Properties.functionalities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		functionalities.refresh();
	}
	...
	protected void removeFromFunctionalities(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmProductPropertiesEditionPartImpl.this, BsmViewsRepository.BsmProduct.Properties.functionalities, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		functionalities.refresh();
	}
