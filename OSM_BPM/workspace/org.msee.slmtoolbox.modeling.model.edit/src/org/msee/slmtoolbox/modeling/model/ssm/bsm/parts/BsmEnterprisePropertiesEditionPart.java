 ...
 * 
 */
public interface BsmEnterprisePropertiesEditionPart {
	...
	/**
	 * Init the veParticipations
	 * @param settings settings for the veParticipations ReferencesTable 
	 */
	public void initVeParticipations(ReferencesTableSettings settings);

	/**
	 * Update the veParticipations
	 * @param newValue the veParticipations to update
	 * 
	 */
	public void updateVeParticipations();

	/**
	 * Adds the given filter to the veParticipations edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the veParticipations table
	 * 
	 */
