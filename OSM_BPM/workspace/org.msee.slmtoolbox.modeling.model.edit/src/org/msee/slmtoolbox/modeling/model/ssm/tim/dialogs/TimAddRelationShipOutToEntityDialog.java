...
public class TimAddRelationShipOutToEntityDialog extends AbstractTimElementDialog<TimInformationEntity, TimInformationRelationship> {
	 ...
	 * 
	 */
	public TimAddRelationShipOutToEntityDialog(Shell parentShell, ILabelProvider labelProvider,
	...
	protected void addNewElementToElementTarget(TimInformationRelationship newElement) {
		newElement.setSourceEntity(getElementBeCompleted());
		getElementBeCompleted().getOutRelations().add(newElement);
	}
}