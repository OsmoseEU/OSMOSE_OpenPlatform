 ...
 * 
 */
public interface BsmPiFieldPropertiesEditionPart {
	...
	/**
	 * @return the performanceIndicators
	 * 
	 */
	...
	/**
	 * Defines a new performanceIndicators
	 * @param newValue the new performanceIndicators to set
	 * 
	 */
