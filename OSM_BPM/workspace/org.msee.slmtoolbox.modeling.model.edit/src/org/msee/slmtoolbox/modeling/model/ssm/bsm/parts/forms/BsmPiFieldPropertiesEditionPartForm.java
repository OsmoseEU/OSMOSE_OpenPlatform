 ...
 * 
 */
public class BsmPiFieldPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, BsmPiFieldPropertiesEditionPart {
	 ...
	 */
	public BsmPiFieldPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public BsmPiFieldPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(bsmPiFieldStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == BsmViewsRepository.BsmPiField.Properties.performanceIndicators) {
					return createPerformanceIndicatorsFlatComboViewer(parent, widgetFactory);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(BsmMessages.BsmPiFieldPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							BsmPiFieldPropertiesEditionPartForm.this,
							BsmViewsRepository.BsmPiField.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmPiFieldPropertiesEditionPartForm.this, BsmViewsRepository.BsmPiField.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, BsmViewsRepository.BsmPiField.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmPiField.Properties.name, BsmViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * 
	 */
	protected Composite createPerformanceIndicatorsFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		performanceIndicators = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(BsmViewsRepository.BsmPiField.Properties.performanceIndicators, BsmViewsRepository.FORM_KIND));
		widgetFactory.adapt(performanceIndicators);
		...
		performanceIndicators.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BsmPiFieldPropertiesEditionPartForm.this, BsmViewsRepository.BsmPiField.Properties.performanceIndicators, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPerformanceIndicators()));
			}

		});
		performanceIndicators.setID(BsmViewsRepository.BsmPiField.Properties.performanceIndicators);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(BsmViewsRepository.BsmPiField.Properties.performanceIndicators, BsmViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
