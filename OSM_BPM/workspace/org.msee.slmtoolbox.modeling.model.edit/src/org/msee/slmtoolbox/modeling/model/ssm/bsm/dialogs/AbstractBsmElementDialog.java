 ...
 * @author HBA6
 *
 * @param <T>	bsm element to be completed
 * @param <S>	bsm element to add
 */
public abstract class AbstractBsmElementDialog<T extends  EObject, S extends  EObject> extends AbstractMSeEElementDialog<T, S> {
	 ...
	 * 
	 */
	public AbstractBsmElementDialog(Shell parentShell, ILabelProvider labelProvider,
