 ...
 * 
 */
public class RootMessages extends NLS {
	
	private static final String BUNDLE_NAME = "org.msee.slmtoolbox.modeling.model.lang.eaStar.root.providers.rootMessages"; //$NON-NLS-1$

	
	public static String EaModelPropertiesEditionPart_PropertiesGroupLabel;


	
	public static String EaModel_ReadOnly;

	
	public static String EaModel_Part_Title;


	
	public static String EaModelPropertiesEditionPart_NameLabel;

	
	public static String EaModelPropertiesEditionPart_CodeLabel;

	
	public static String EaModelPropertiesEditionPart_DescriptionLabel;
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, RootMessages.class);
	}

	
	private RootMessages() {
