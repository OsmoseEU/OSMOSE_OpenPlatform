 ...
 * 
 */
public interface EaMaterialResourcePropertiesEditionPart {
	...
	/**
	 * Defines a new unitaryCost
	 * @param newValue the new unitaryCost to set
	 * 
	 */
	...
	/**
	 * Defines a new capabilities
	 * @param newValue the new capabilities to set
	 * 
	 */
