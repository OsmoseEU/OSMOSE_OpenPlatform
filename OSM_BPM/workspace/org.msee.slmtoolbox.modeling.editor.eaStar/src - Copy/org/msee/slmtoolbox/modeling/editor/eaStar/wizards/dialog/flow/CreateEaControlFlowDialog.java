...
public class CreateEaControlFlowDialog extends AbstractCreateEaFlowDialog {
     ...
     */
    public CreateEaControlFlowDialog(Shell parentShell, EaProcess process,EaFlowNode source, EaFlowNode target, EAStarAppService service) {
	...
	protected EaFlow createFlow(EaProcess process, EaFlowNode source, EaFlowNode target) {
		return getAppService().createControlFlow(process, source, target);
	}
