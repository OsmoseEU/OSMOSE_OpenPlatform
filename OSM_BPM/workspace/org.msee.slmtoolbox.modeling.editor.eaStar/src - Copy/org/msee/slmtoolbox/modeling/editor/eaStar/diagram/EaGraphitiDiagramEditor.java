...
/**
 * Implementation eaStar GraphitiDiagramEditor with a EAStarAppService
 * @author FTO
 */
public class EaGraphitiDiagramEditor extends AbstractMseeGraphitiDiagramEditor<EAStarAppService> {
	
	/**
	 * Default constructor
	 */
	public EaGraphitiDiagramEditor() {
		super();
	}
	...
	public void init(IEditorSite site, IEditorInput input)
		...
		this.setAppService(BsmProjectManager.eInstance.createEaService(getDiagramUri()));
	}
}
