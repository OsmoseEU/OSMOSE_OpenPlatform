...
/**
 * Dialog for add a MseAssetClass to BsmResource
 * @author fto
 *
 */
public class AddMseServiceToResourceDialog extends JDialog {
	   ...
	   /** serialVersionUID */
		...
		private ModifyServiceURLPanel modifyServiceUrlPanel;
		 ...
		 */
		public AddMseServiceToResourceDialog(Shell parentShell, EaResource resource,
			...
			// create attribute
			this.modifyServiceUrlPanel = new ModifyServiceURLPanel(this.service, this.cancelAction, this.nextAction);
			...
			this.add(this.modifyServiceUrlPanel);
		...
		private void importService() {
			...
			this.service.addMseServiceToResource(this.resource,this.selectServicePanel.getMseService());
			this.dispose();
		}
		...
		private void next(){
			...
			this.service.updateRestURL(modifyServiceUrlPanel.getNewUrl().getText());
			try{
				this.testConnection();
				JPanel contentPane = (JPanel) this.getContentPane();
				this.remove(modifyServiceUrlPanel);
				...
				modifyServiceUrlPanel.getNewUrl().setText(defaultUrl);
