...
/**
 * Dialog for add a MseService to BsmResource
 * @author fto
 *
 */
public class UpdateMseServiceToResourceDialog extends JDialog {
	  ...
	  /** serialVersionUID */
		 ...
		 */
		public UpdateMseServiceToResourceDialog(Shell parentShell, EaResource resource,
			...
			BsmMseService currentService =  this.service.getMseServiceToResource(this.resource);
