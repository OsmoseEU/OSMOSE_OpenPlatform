 ...
 *
 */
public class CreateEaStructuralExtendedActivityDialog extends AbstractMseeDialog<EAStarAppService> {
	/**
     * Input combo widget.
     */
    private Combo combo;
     ...
     * 			
     */
    public CreateEaStructuralExtendedActivityDialog(Shell parentShell, EaProcess process, EaOrganization eaOrganization, EAStarAppService service,
    		 String title) {
