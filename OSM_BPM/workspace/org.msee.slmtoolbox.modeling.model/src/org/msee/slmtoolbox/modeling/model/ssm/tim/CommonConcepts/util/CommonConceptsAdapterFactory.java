/**
 */
package org.msee.slmtoolbox.modeling.model.ssm.tim.CommonConcepts.util;
 ...
 * @generated
 */
public class CommonConceptsAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static CommonConceptsPackage modelPackage;
	 ...
	 * @generated
	 */
	public CommonConceptsAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = CommonConceptsPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected CommonConceptsSwitch<Adapter> modelSwitch =
		new CommonConceptsSwitch<Adapter>() {
			@Override
			public Adapter caseTimService(TimService object) {
				return createTimServiceAdapter();
			}
			@Override
			public Adapter caseTimProcess(TimProcess object) {
				return createTimProcessAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.msee.slmtoolbox.modeling.model.ssm.tim.CommonConcepts.TimService <em>Tim Service</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.msee.slmtoolbox.modeling.model.ssm.tim.CommonConcepts.TimProcess <em>Tim Process</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
