...
public class TimAdapterFactory extends AdapterFactoryImpl {
	...
	protected TimSwitch<Adapter> modelSwitch =
		new TimSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTimModel(TimModel object) {
				return createTimModelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.msee.slmtoolbox.modeling.model.ssm.tim.TimModel <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
