...
public class RootAdapterFactory extends AdapterFactoryImpl {
	...
	protected RootSwitch<Adapter> modelSwitch =
		new RootSwitch<Adapter>() {
			@Override
			public Adapter caseGgModel(GgModel object) {
				return createGgModelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.msee.slmtoolbox.modeling.model.lang.graiGrid.root.GgModel <em>Gg Model</em>}'.
	 * <!-- begin-user-doc -->
