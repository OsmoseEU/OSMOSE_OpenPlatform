/**
 */
package org.msee.slmtoolbox.modeling.model.lang.eaStar.generalElements.util;
...
import org.msee.slmtoolbox.modeling.model.lang.eaStar.generalElements.*;
...
public class GeneralElementsAdapterFactory extends AdapterFactoryImpl {
	...
	protected GeneralElementsSwitch<Adapter> modelSwitch =
		new GeneralElementsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseEaProcess(EaProcess object) {
				return createEaProcessAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.msee.slmtoolbox.modeling.model.lang.eaStar.generalElements.EaProcess <em>Ea Process</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.msee.slmtoolbox.modeling.model.lang.eaStar.generalElements.EaProcess
	 * @generated
	 */
