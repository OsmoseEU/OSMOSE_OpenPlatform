/**
 */
package org.msee.slmtoolbox.modeling.model.lang.graiGrid.root.util;
 ...
 * <!-- end-user-doc -->
 * @see org.msee.slmtoolbox.modeling.model.lang.graiGrid.root.RootPackage
 * @generated
 */
public class RootSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RootPackage.GG_MODEL: {
				GgModel ggModel = (GgModel)theEObject;
				T result = caseGgModel(ggModel);
				if (result == null) result = caseGgBaseElement(ggModel);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Gg Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Gg Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGgModel(GgModel object) {
		return null;
	}
