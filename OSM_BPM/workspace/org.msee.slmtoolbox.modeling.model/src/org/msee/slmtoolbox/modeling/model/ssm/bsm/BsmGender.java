 ...
 * <!-- end-user-doc -->
 * @see org.msee.slmtoolbox.modeling.model.ssm.bsm.BsmPackage#getBsmGender()
 * @model
 * @generated
 */
public enum BsmGender implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final BsmGender[] VALUES_ARRAY =
		new BsmGender[] {
			FEMALE,
			MALE,
		};
	 ...
	 * @generated
	 */
	public static final List<BsmGender> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static BsmGender get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			BsmGender result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static BsmGender getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			BsmGender result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static BsmGender get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private BsmGender(int value, String name, String literal) {
		this.value = value;
		this.name = name;
