...
/**
 * Page wizard for select Eastar source and name new file
 * @author fto
 *
 */
public class EaToBpmnWizardPageSelectFile extends WizardPage {
	/** page name */
	 ...
	 * @param pageName
	 */
	public EaToBpmnWizardPageSelectFile(ISelection selection) {
		super(PAGE_NAME);
